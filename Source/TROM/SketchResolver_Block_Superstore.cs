...
internal class SketchResolver_Block_Superstore : SketchResolver
{
    ...
    protected override void ResolveInt(ResolveParams parms)
    {
        ...
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 14), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 15), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 18), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 19), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 20), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 21), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 24), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 25), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 26), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(26, 0, 27), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(27, 0, 27), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(28, 0, 27), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(30, 0, 27), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(ThingDefOf.Fence, new IntVec3(31, 0, 27), Rot4.North, ThingDefOf.Steel);
        ...
        sketch.AddThing(ThingDefOf.PlantPot, new IntVec3(36, 0, 36), Rot4.North);
        sketch.AddThing(ThingDefOf.PlantPot, new IntVec3(33, 0, 26), Rot4.North);
        sketch.AddThing(ThingDefOf.Table1x2c, new IntVec3(35, 0, 29), Rot4.East);
        sketch.AddThing(ThingDefOf.Stool, new IntVec3(35, 0, 28), Rot4.North);
        sketch.AddThing(ThingDefOf.Stool, new IntVec3(36, 0, 28), Rot4.North);
        sketch.AddThing(ThingDefOf.Stool, new IntVec3(35, 0, 30), Rot4.North);
        sketch.AddThing(ThingDefOf.Stool, new IntVec3(36, 0, 30), Rot4.North);
