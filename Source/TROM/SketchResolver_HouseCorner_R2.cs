...
internal class SketchResolver_HouseCorner_R2 : SketchResolver
{
    ...
    protected override void ResolveInt(ResolveParams parms)
    {
        ...
        for (var num = 0; num < things.Count; num++)
        {
            if (things[num].def == ThingDefOf.Wall)
            {
                sketch.RemoveTerrain(things[num].pos);
            }
        }
        ...
        {
            sketch.AddThing(ThingDefOf.PlantPot, new IntVec3(9, 0, 3), Rot4.North);
        }
        ...
        {
            sketch.AddThing(ThingDefOf.PlantPot, new IntVec3(3, 0, 9), Rot4.North);
        }
