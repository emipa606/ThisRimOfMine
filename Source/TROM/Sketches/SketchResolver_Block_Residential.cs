...
internal class SketchResolver_Block_Residential : SketchResolver
{
    ...
    private void ResolveEdges(ResolveParams parms)
    {
        ...
        while (num3 - num2 > 0)
        {
            ...
            parms.sketch.MergeAt(resolveParams.sketch, new IntVec3(num2, 0, 0));
            roofListTmp = sketchResolverDef == TROMSketchResolverDefOf.HouseEdge
                ? [new CellRect(0, 0, num, height)]
                : GetRoofList(sketchResolverDef, resolveParams);
        ...
        while (num5 - num4 > 0)
        {
            ...
            parms.sketch.MergeAt(resolveParams2.sketch, new IntVec3(0, 0, 37 - num4));
            roofListTmp = sketchResolverDef2 == TROMSketchResolverDefOf.HouseEdge
                ? [new CellRect(0, 0, num, height)]
                : GetRoofList(sketchResolverDef2, resolveParams2);
        ...
        while (num7 - num6 > 0)
        {
            ...
            resolveParams3.sketch.Rotate(Rot4.South);
            parms.sketch.MergeAt(resolveParams3.sketch, new IntVec3(37 - num6, 0, 37));
            roofListTmp = sketchResolverDef3 == TROMSketchResolverDefOf.HouseEdge
                ? [new CellRect(0, 0, num, height)]
                : GetRoofList(sketchResolverDef3, resolveParams3);
        ...
        while (num9 - num8 > 0)
        {
            ...
            parms.sketch.MergeAt(resolveParams4.sketch, new IntVec3(37, 0, num8));
            roofListTmp = sketchResolverDef4 == TROMSketchResolverDefOf.HouseEdge
                ? [new CellRect(0, 0, num, height)]
                : GetRoofList(sketchResolverDef4, resolveParams4);
