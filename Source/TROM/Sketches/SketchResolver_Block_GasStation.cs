...
internal class SketchResolver_Block_GasStation : SketchResolver
{
    ...
    private void ResolveGasStation(ResolveParams parms)
    {
        ...
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 14), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 15), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 16), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 17), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 18), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 19), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 6), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 5), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 4), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 3), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(10, 0, 2), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 6), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 5), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 4), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 3), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 2), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 8), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 9), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 10), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 11), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 12), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 14), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 15), Rot4.North, ThingDefOf.Steel);
        sketch.AddThing(fenceDef, new IntVec3(2, 0, 16), Rot4.North, ThingDefOf.Steel);
        for (var k = 0; k < 9; k++)
        {
            for (var l = 0; l < 16; l++)
            {
